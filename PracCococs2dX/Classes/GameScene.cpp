...
vector<Index *> g_pVIndex;

typedef vector<Index *> Tpv_Index;
...
//void GameScene::getEliminateArray2(Index index,const unsigned int color)
//{
...
//                tSprite->move();
                tSprite->scheduleOnce(schedule_selector(FruitObject::move), (Iabs(i - it->size()))*0.1);
            }
        }
